...
# def _handle_message(_message, _from):
...
#         _handle_message(message, conn)

#
# def _listen_for_connection():
#     while True:
...
#
#         conn_thread = threading.Thread(target=_handle_connection, args=(conn, addr))
#         conn_thread.start()
...
#         _listen = executor.submit(_listen_for_connection)
